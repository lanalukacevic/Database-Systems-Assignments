...
/* Assignment 7 Task 2a: Create a new table shape2d with columns: shape_id, shape_name, perimeter_formula, area_formula */
...
/* Assignment 7 Task 2b: Insert two rows into the shape3d table, at least one of which should involve π. */
...
/* Assignment 7 Task 2b: Retrieve shape2d contents*/
SELECT * FROM math_shape2d;


DROP TABLE IF EXISTS math_shape3d;
/* Assignment 7 Task 3a: Create a new table shape3d with columns: shape_id, shape_name, area_formula, volume_formula */
...
/* Assignment 7 Task 3b: Insert two rows into the shape3d table, at least one of which should involve π. */
...
/* Assignment 7 Task 3b: Retrieve shape3d contents */
SELECT * FROM math_shape3d;

DROP FUNCTION IF EXISTS area_circle;
/* Assignment 7 Task 4a: Create a MySQL function area_circle(radius) that computes the area of a circle of given radius */
...
/* Testing function: Area circle using dual */
SELECT area_circle(2) from dual;


DROP FUNCTION IF EXISTS volume_sphere;
/* Assignment7 Task 4b: Create a MySQL function volume_sphere(radius) that computes the volume of a sphere of given radius */
...
/* Testing function: Volume sphere using dual */
SELECT volume_sphere(2) from dual;


DROP TABLE IF EXISTS math_circle;
/* Assignment 7 Task 5a: Create a table circle with columns circle_id, total_points, circle_points, pi_estimate */
...
/* Assignment 7 Task 5b: Create a table point with columns point_id, circle_id, x, y. */
...
/* Assignment 7 Task 5c/5d: Create a stored procedure random_points(n) that generates n random points (x, y) where both x and y are in the interval (-1, 1) */
...
/* Assignment 7 Task 6: Create a function estimate_pi() */
...
/* Assignment 7 Task 7: Create procedure run test */
...
/* Assignment 7 Task 8: Run test for 100 points */
CALL run_test(100);
/* Assignment7 Task 8: Run test for 1000 points */
CALL run_test(1000);
/* Assignment7 Task 8: Run test for 10'000 points */
CALL run_test(10000);

/* Assignment 7 Task 9: Find estimate of pi for different n */
SELECT * FROM math_circle;